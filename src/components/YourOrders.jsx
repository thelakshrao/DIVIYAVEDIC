  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setProducts(
          prodSnap.docs.map((d) => ({ id: d.id, ...d.data() })).slice(0, 12),
        );
      } catch (e) {
        console.error(e);
      }
  ...
  return (
    <div className="min-h-screen bg-[#fdf8f0] font-['DM_Sans',sans-serif]">
      <div className="fixed inset-0 pointer-events-none z-0 flex items-center justify-center overflow-hidden">
        <span className="text-[520px] font-serif text-amber-700/[0.022] select-none leading-none">
          ॐ
        </span>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-8 py-8 pb-20">
        <div className="mb-8">
          ...
          <h1 className="font-['Cinzel',serif] text-[28px] font-bold text-[#44260a] m-0 mb-1 tracking-wide">
            Your Orders
          </h1>
          <p className="font-['Cormorant_Garamond',serif] italic text-[16px] text-[#b08050] m-0">
            {orders.length > 0
              ? `${orders.length} order${orders.length !== 1 ? "s" : ""} placed`
              : "Your sacred order history"}
          </p>
        </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="bg-white border border-amber-700/10 rounded-2xl p-4 mb-5 shadow-sm relative overflow-hidden">
              ...
              <div className="relative mb-3">
                <svg
                  className="absolute left-3.5 top-1/2 -translate-y-1/2 text-amber-700/40 pointer-events-none"
                  width="15"
                  height="15"
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                {search && (
                  <button
                    onClick={() => setSearch("")}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-amber-700/40 hover:text-amber-700 bg-transparent border-none cursor-pointer text-sm"
                  >
                    ✕
                  </button>
                )}
            ...
            {loading ? (
              <div className="space-y-4">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="bg-white border border-amber-700/10 rounded-2xl p-5 shadow-sm animate-pulse"
                  >
              ...
              <div className="bg-white border border-amber-700/10 rounded-2xl p-12 shadow-sm text-center relative overflow-hidden">
                ...
                {orders.length === 0 ? (
                  <>
                    <p className="font-['Cinzel',serif] text-[18px] font-semibold text-amber-800 mb-2">
                      No Orders Yet
                    </p>
                    <p className="font-['Cormorant_Garamond',serif] italic text-[16px] text-amber-700/50 mb-6">
                      Your sacred shopping journey begins here.
                      <br />
                      Start exploring our vedic collection.
                    </p>
                    <button
                  ...
                  <>
                    <p className="font-['Cinzel',serif] text-[16px] font-semibold text-amber-800 mb-2">
                      No Results Found
                    </p>
                    <p className="font-['Cormorant_Garamond',serif] italic text-[15px] text-amber-700/45 mb-4">
              ...
              <div className="space-y-4">
                {filtered.map((o) => {
                  ...
                  const productName =
                    o.productName || items[0]?.productName || "—";

                  return (
                    <div
                      key={o.id}
                      className="bg-white border border-amber-700/10 rounded-2xl shadow-sm relative overflow-hidden hover:shadow-[0_4px_24px_rgba(120,53,15,0.1)] hover:border-amber-700/18 transition-all"
                    >
                      <div className="absolute top-0 left-0 right-0 h-0.5 bg-linear-to-r from-transparent via-amber-400 to-transparent" />
                      ...
                      <div className="flex items-center justify-between px-5 py-3 border-b border-amber-700/6 bg-amber-50/40 flex-wrap gap-2">
                        <div className="flex items-center gap-6 flex-wrap">
                          <div>
                            <div className="text-[9px] text-amber-700/45 uppercase tracking-widest font-semibold mb-0.5">
                              Order Placed
                            </div>
                          ...
                          <div>
                            ...
                            <div className="font-['Cinzel',serif] text-[14px] font-bold text-amber-700">
                          ...
                          <div>
                            ...
                            <div className="text-[12px] text-amber-900/70">
                              {o.paymentMode === "cod"
                                ? "Cash on Delivery"
                                : "Online"}
                            </div>
                        ...
                        <div className="text-right">
                          ...
                          <div className="font-['Cinzel',serif] text-[13px] font-bold text-amber-700">
                            {o.orderId || o.id}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-5">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-['Cinzel',serif] text-[14px] font-semibold text-[#44260a] mb-1 truncate">
                              {productName}
                            </p>
                            {items.length > 1 && (
                              <p className="text-[12px] text-amber-700/50 mb-1">
                          ...
                          <div className="text-right shrink-0">
                            <div className="mb-2">
                              <span
                                className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold border ${sc}`}
                              >
                                <span>{si}</span>
                                {o.status || "Pending"}
                              </span>
                        ...
                        <div className="flex items-center gap-2 mt-4 pt-3 border-t border-amber-700/6 flex-wrap">
                          {o.productId && (
                            <button
                              onClick={() => navigate(`/buy/${o.productId}`)}
          ...
          <div className="w-72 shrink-0 hidden lg:block">
            <div className="bg-white border border-amber-700/10 rounded-2xl shadow-sm relative overflow-hidden top-6">
              ...
              <div className="p-5 border-b border-amber-700/6">
                <p className="font-['Cinzel',serif] text-[13px] font-semibold text-amber-900 mb-0.5">
                  You May Also Like
                </p>
                <p className="font-['Cormorant_Garamond',serif] italic text-[12px] text-amber-700/45">
                  Vedic items for you
                </p>
              </div>
              <div className="p-3 max-h-[calc(100vh-180px)] overflow-y-auto">
                {products.length === 0 ? (
                  <p className="text-center py-8 font-['Cormorant_Garamond',serif] italic text-[13px] text-amber-700/40">
                    No products yet.
                  </p>
                ) : (
                    ...
                    {products.map((p) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-['Cinzel',serif] text-[11px] font-semibold text-[#44260a] truncate group-hover:text-amber-700 transition-colors">
                              {p.name}
                            </p>
                            <p className="font-['Cormorant_Garamond',serif] italic text-[11px] text-amber-700/50 truncate">
                              {p.brand || p.category}
                            </p>
                            <div className="flex items-center gap-1.5 mt-0.5">
                              <span className="font-['Cinzel',serif] text-[12px] font-bold text-amber-700">
                                ₹{p.price}
                              </span>
                              {disc > 0 && (
